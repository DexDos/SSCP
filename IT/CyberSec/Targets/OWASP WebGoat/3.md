...
- `substring(...) = $a$` — character substring which is meant to contain basic and common chars `[a-Z]`, `[0-9]`, `[special chars]`. In order to increase the speed we sill firstly fuzz through `[a-z]` range and from then we will decide whether it is needed to more.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| t   | h   | i   | s   | i   | s   | a   | s   | e   | c   | r   | e   | t   | f   | o   | r   | t   | o   | m   | o   | n   | l   |     |
...
- It is never an apteryx (`*`). We can assume that only in `SELECT *` like situations.  
...
As it is mentioned [[#Question1|previously]], prepared statements are compiled once and being used as a sort of function afterwards, receiving parameters and so on. 
#### Question 4
